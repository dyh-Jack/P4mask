...
if __name__ == '__main__':
    ...
    P4 = P4Transformer(radius=0.7, nsamples=32, spatial_stride=32, temporal_kernel_size=3, temporal_stride=2, emb_relu=False, dim=1024, depth=5, heads=8, dim_head=128, mlp_dim=2048, num_classes=20)
    P4 = P4.to(device)
